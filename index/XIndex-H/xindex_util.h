...
#if !defined(XINDEX_UTIL_Hh)
#define XINDEX_UTIL_Hh
...
struct IndexConfig {
  ...
  double hash_resize_tolerance_upper = 1.5;
  double hash_resize_tolerance_lower = 0.5;
  double hash_init_conflict_threshold = 0.4;
  size_t worker_n = 0;
