...
inline void bm_insert(benchmark::State& state, ViperFixture& fixture, ViperConfig v_config) {
...
BENCHMARK_DEFINE_F(ViperFixture, insert_dimm_based)(benchmark::State& state) {
    ViperConfig v_config{};
    v_config.force_dimm_based = true;
    bm_insert(state, *this, v_config);
}

BENCHMARK_DEFINE_F(ViperFixture, insert_block_based)(benchmark::State& state) {
    ViperConfig v_config{};
